...
<div class="modal-dialog" role="document">
	<div class="modal-content">
		...
		<?php echo form_open('/customer-management/pagerduty/do-activate/'.$client_code, array('id'=>'general_action', 'role'=>'form', 'class'=>'element-action-form')); ?>
		
		<div class="modal-body">
			<h5>Enable PagerDuty API for:</h5>
